...
a = 5;  % Length in cm in x-direction
b = 5;    % Length in cm in y-direction
f = 60*10.^9;   % Frequency of operation 45GHz
...
M = 30;                         % Number of points to be poltted
